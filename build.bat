...
:: try static libs
rem  sed -i "s|SET(BUILD_SHARED_LIBS TRUE)|SET(BUILD_SHARED_LIBS FALSE)|g" homard\CMakeLists.txt
rem  sed -i "/HOMARDENGINE_EXPORT/d" homard\src\HOMARD_I\HOMARD_Gen_i_Session.cxx
...
:: try use MESSAGE
pushd C:\work\SALOME-9.10.0\W64\HOMARD\bin
dir /p .
echo "try_link_kernel.exe..."
.\try_link_kernel.exe
echo "errorlevel=%errorlevel%"
echo "try_link_kernel.exe...cmd"
cmd /c try_link_kernel.exe
echo "errorlevel=%errorlevel%"
popd
echo "try_link_kernel.exe...nope"
